...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqp.connect('amqps://bshhulim:DYXAQIkuFG9jUMcR94QpSZHKlPQgu4Xr@jackal.rmq.cloudamqp.com/bshhulim', function (error0, connection) {
        if (error0) {
            throw error0;
        }
        connection.createChannel(function (error1, channel) {
            ...
            // Get product by id
            channel.consume('product_by_id', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var eventProduct;
                return __generator(this, function (_a) {
                    eventProduct = JSON.parse(msg.content.toString());
            ...
            channel.consume('product_updated', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            eventProduct = JSON.parse(msg.content.toString());
                            return [4 /*yield*/, productRepository.findOne({ where: { id: eventProduct.id } })];
                        case 1:
                            product = _a.sent();
            ...
            channel.consume('product_deleted', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var eventProduct, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            eventProduct = JSON.parse(msg.content.toString());
                            return [4 /*yield*/, productRepository.delete(eventProduct.id)];
                        case 1:
                            result = _a.sent();
            ...
            // Like product
            channel.consume('product_like', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var eventProduct, product, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            // get products
            app.get('/api/product', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var products;
                return __generator(this, function (_a) {
                    switch (_a.label) {
            ...
            app.post('/api/product', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            product = _a.sent();
                            return [4 /*yield*/, productRepository.save(req.body)];
                        case 2:
                            result = _a.sent();
            ...
            app.get('/api/product/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.findOne({ where: { id: req.params.id } })];
                        case 1:
                            product = _a.sent();
